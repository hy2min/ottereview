...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    @Transactional
    public ReviewResponse createReview(Long accountId, Long repoId, Long prId, ReviewRequest reviewRequest, Long userId) {
    ...
    @Override
    @Transactional
    public ReviewResponse createReviewWithFiles(Long accountId, Long repoId, Long prId, ReviewRequest reviewRequest, MultipartFile[] files, Long userId) {
        User user = userRepository.findById(userId)
            .orElseThrow(() -> new RuntimeException("User not found: " + userId));
    ...
    @Override
    @Transactional
    public ReviewResponse updateReview(Long accountId, Long repoId, Long prId, Long reviewId, ReviewRequest reviewRequest, Long userId) {
        ...
        Review updatedReview = Review.builder()
            ...
            .state(reviewRequest.getState())
            .body(reviewRequest.getBody())
            .commitSha(reviewRequest.getCommitSha() != null ? reviewRequest.getCommitSha() : review.getCommitSha())
