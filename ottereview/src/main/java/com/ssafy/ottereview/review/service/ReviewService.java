...
public interface ReviewService {
    ...
    ReviewResponse createReview(Long accountId, Long repoId, Long prId, ReviewRequest reviewRequest, Long userId);
    
    ReviewResponse createReviewWithFiles(Long accountId, Long repoId, Long prId, ReviewRequest reviewRequest, MultipartFile[] files, Long userId);
    
    ReviewResponse updateReview(Long accountId, Long repoId, Long prId, Long reviewId, ReviewRequest reviewRequest, Long userId);
