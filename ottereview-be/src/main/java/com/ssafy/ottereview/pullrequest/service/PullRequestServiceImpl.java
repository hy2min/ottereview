        ...
        List<Description> descriptionList = descriptions.stream()
                .map(descriptionInfo ->
                        Description.builder()
                                ...
                                .startLine(descriptionInfo.getStartLine())
                                .startSide(descriptionInfo.getStartSide())
                                .line(descriptionInfo.getLine())
                                .side(descriptionInfo.getSide())
                                .diffHunk(descriptionInfo.getDiffHunk())
