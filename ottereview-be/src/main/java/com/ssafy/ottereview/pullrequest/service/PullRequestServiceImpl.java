...
public class PullRequestServiceImpl implements PullRequestService {
    ...
    public PullRequestResponse getPullRequestByBranch(CustomUserDetail userDetail, Long repoId, String source, String target) {
        ...
        PullRequest existPullRequest = pullRequestRepository.findByRepoAndBaseAndHeadAndState(repo, target, source, PrState.OPEN).orElseThrow(() -> new IllegalArgumentException(
    ...
    public void createPullRequestWithMediaFiles(CustomUserDetail customUserDetail, Long repoId,
        ...
        createDescriptionsWithService(prepareInfo, savePullRequest, customUserDetail.getUser().getId(), mediaFiles);
    }

    /**
     * DescriptionService를 사용한 설명 일괄 생성
     * develop 브랜치의 PreparationResult 구조에 맞춰 수정
     */
