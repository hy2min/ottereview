...
public class RepoController {
    ...
    /**
     * UserId를 가지고 사용자가 저장한 레포지토리 list를 반환한다. Method : GET
     *
    ...
    /**
     * cushion 적용 여부를 전달하는 method , 일단 해당 레포Id에 따른 cushion값을 boolean값으로 반환하는걸로 처리했다. 레포조회를 통해서 repo
     * 전체 내용을 보내는 메소드로 처리가능해보임 (추후 논의 사항)
     *
     * @param id
