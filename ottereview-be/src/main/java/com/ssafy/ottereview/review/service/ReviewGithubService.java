...
public interface ReviewGithubService {
    GithubReviewResponse createReviewOnGithub(Long installationId, String repoFullName, int githubPrNumber, String body, @NotNull ReviewState state, @Valid List<ReviewCommentCreateRequest.CommentItem> reviewComments, String githubUsername);
    ...
    void deleteReviewCommentOnGithub(Long installationId, String repoFullName, Long commentId);
}
