...
const PRFileList = ({ files, onAddComment, onRemoveComment, fileComments = {}, existingReviewComments = {}, descriptions = [], prAuthor = {}, showDiffHunk = false, prId, onDescriptionUpdate, onDescriptionDelete, commentMode = 'review', onDataRefresh }) => {
