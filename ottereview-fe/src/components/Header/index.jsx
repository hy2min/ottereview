        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-12 h-12 bg-white dark:bg-slate-800 rounded-xl p-1.5 shadow-lg group-hover:shadow-2xl transition-all duration-500 border-2 border-gray-200/50 dark:border-slate-700/50 group-hover:border-blue-400/50 dark:group-hover:border-blue-500/50">
                ...
                <div className="absolute -bottom-1 -left-1 w-1.5 h-1.5 bg-purple-400 rounded-full opacity-0 group-hover:opacity-80 group-hover:animate-pulse transition-all duration-500" style={{ animationDelay: '0.2s' }} />
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {/* Icon glow effect */}
              <div className={`absolute inset-2 rounded-lg opacity-0 group-hover:opacity-50 blur-sm transition-all duration-500 ${theme === 'light' ? 'bg-purple-500' : 'bg-yellow-500'}`} />
            </button>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.target.style.boxShadow = '0 0 30px rgba(239, 68, 68, 0.5), 0 0 60px rgba(236, 72, 153, 0.3)';
              }}
              onMouseLeave={(e) => {
